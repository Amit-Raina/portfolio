...
function Header() {
  const intl = useIntl();
  const [headerItem, setHeaderItem] = useState(headerOptions?.[0]?.key);
  return (
    <div className="header flex fs16 fwb alignCenter">
      <div className="flex justifySpaceBetween alignCenter common-alignment ">
